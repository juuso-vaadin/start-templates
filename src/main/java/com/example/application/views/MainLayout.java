...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Start templates");
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("List - Item - Detail", ListItemDetailView.class,
                LineAwesomeIcon.COLUMNS_SOLID.create()));
        nav.addItem(new AppNavItem("Wizard", WizardView.class, LineAwesomeIcon.HAT_WIZARD_SOLID.create()));
        nav.addItem(new AppNavItem("Search Results", SearchResultsView.class, LineAwesomeIcon.SEARCH_SOLID.create()));
